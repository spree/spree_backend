...
module Spree
  module Backend
    class Engine < ::Rails::Engine
      Environment = Struct.new(:main_menu, :order_tabs, :user_tabs, :product_tabs)
      ...
      config.after_initialize do
        ...
        Rails.application.config.spree_backend.order_tabs = Spree::Admin::Tabs::OrderDefaultTabsBuilder.new.build
        Rails.application.config.spree_backend.user_tabs = Spree::Admin::Tabs::UserDefaultTabsBuilder.new.build
        Rails.application.config.spree_backend.product_tabs = Spree::Admin::Tabs::ProductDefaultTabsBuilder.new.build
      end
    end
  end
end
