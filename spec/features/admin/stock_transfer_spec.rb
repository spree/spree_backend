...
#   let!(:product) { create(:product, name: 'Fluffy Toy Monkey', sku: 'A99400', description: 'lorem ipsum') }
...
#     select2_open label: 'Variant'
#     select2_search 'Fluffy Toy Monkey', from: 'Variant'
#     select2_select 'Fluffy Toy Monkey', from: 'Variant', match: :first
